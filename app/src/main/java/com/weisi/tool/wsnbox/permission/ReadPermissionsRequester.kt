 ...
 */
class ReadPermissionsRequester(activity: Activity, requestCode: Int) : PermissionsRequester(activity, requestCode, arrayOf(android.Manifest.permission.READ_EXTERNAL_STORAGE)) {
