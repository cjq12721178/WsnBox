...
import com.weisi.tool.wsnbox.adapter.browse.BaseSensorAdapterDelegate
import com.weisi.tool.wsnbox.adapter.browse.BaseSensorAdapterDelegate.*
import com.weisi.tool.wsnbox.adapter.browse.DataBrowsePhysicalSensorAdapter
import com.weisi.tool.wsnbox.adapter.browse.MultipleMeasurementSensorAdapterDelegate
import com.weisi.tool.wsnbox.adapter.browse.SingleMeasurementSensorAdapterDelegate
...
//    }
    ...
    override fun onInitAdapter(view: View, storage: Storage<PhysicalSensor>): DataBrowsePhysicalSensorAdapter {
        ...
        rvSensors.addOnItemTouchListener(object : SimpleRecyclerViewItemTouchListener(rvSensors) {
            override fun onItemClick(v: View, position: Int) {
                ...
                getBaseActivity().dataPrepareService.dataTransferStation.payAttentionToPhysicalSensor(sensor)
    ...
    override fun onMissionFinished(result: Boolean) {
        ...
        getBaseActivity().dataPrepareService.dataTransferStation.enableDetectMeasurementHistoryValueReceive = false
    }
