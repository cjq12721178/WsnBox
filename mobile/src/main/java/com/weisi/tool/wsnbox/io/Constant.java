...
public interface Constant {
    ...
    String TAG_CORRECTED_VALUE = "CorrectedValue";
    String TAG_SAMPLING_VALUE = "SamplingValue";
    String TAG_INIT_VALUE = "InitValue";
    String TAG_INIT_INSTANCE = "InitDistance";
    ...
    String COLUMN_CORRECTOR = "corrector";
    String COLUMN_CUSTOM_UNIT = "custom_unit";
    String COLUMN_DECIMALS = "decimals";
}
