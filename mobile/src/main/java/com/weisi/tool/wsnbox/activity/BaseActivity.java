...
import com.weisi.tool.wsnbox.permission.InstallPackagesPermissionsRequester;
...
public abstract class BaseActivity
    ...
    private static final int RC_UPDATE_VERSION = 1;
...
//        }
    ...
    protected void updateVersion(BaseDialog dialog) {
        ...
        new InstallPackagesPermissionsRequester(this, RC_UPDATE_VERSION)
                .requestPermissions(new PermissionsRequester.OnRequestResultListener() {
                    ...
                    public void onPermissionsDenied() {
                        //SimpleCustomizeToast.show(R.string.lack_update_permissions);
                    }
                });
    }
